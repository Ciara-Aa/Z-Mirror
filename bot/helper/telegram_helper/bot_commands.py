...
class _BotCommands:
    def __init__(self):
        ...
        self.QbMirrorCommand = (f'ciaraqbmirror{CMD_SUFFIX}', f'ciaraqm{CMD_SUFFIX}')
        self.QbUnzipMirrorCommand = (f'ciaraqbunzipmirror{CMD_SUFFIX}', f'ciaraquzm{CMD_SUFFIX}')
        self.QbZipMirrorCommand = (f'ciaraqbzipmirror{CMD_SUFFIX}', f'ciaraqzm{CMD_SUFFIX}')
        ...
        self.QbLeechCommand = (f'ciaraqbleech{CMD_SUFFIX}', f'ciaraql{CMD_SUFFIX}')
        self.QbUnzipLeechCommand = (f'ciaraqbunzipleech{CMD_SUFFIX}', f'ciaraquzl{CMD_SUFFIX}')
        self.QbZipLeechCommand = (f'ciaraqbzipleech{CMD_SUFFIX}', f'ciaraqzl{CMD_SUFFIX}')
